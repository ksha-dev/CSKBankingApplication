				...
				<body>
					<section id="menu">
						...
						<div class="items">
							...
							<li style="border-left: 5px solid #fff; background: #0d1117; color: white;"><i
					...
					<section id="content-area">
						<div class="nav-bar">
							...
							<div class="profile">
								<a href="profile.html"> <img src="images/profile.jpg" alt="Profile">
								</a>
							</div>
						</div>
						...
						<div class="content-board">
							...
							<form action="app" id="transferForm" class="container" style="width: 50%;" method="post">
								<div class="dual-element-row">
									<label for="transferWithinBank">Transfer Within Bank</label>
									<div style="justify-content: start; width: 45%;">
										<input id="transferWithinBank" type="checkbox" name="transferWithinBank">
									</div>
								</div>
								<div class="dual-element-row">
									<label for="from-account">Select Account</label> <select name="from-account"
										id="from-account" required>
										<option style="display: none" value="null">Select Account</option>

										<% Map<Long, Account> accounts = (Map<Long, Account>)
								...
								<div class="dual-element-row">
									<label for="to-account">Receipent Account Number</label>
									<input id="to-account" type="number" name="to-account"
								...
								<div class="dual-element-row">
									<label for="amount">Amount to Transfer</label> <input type="number" id="amount"
										name="amount" placeholder="Enter Amount" inputmode="numeric" required>
								</div>

								<div class="dual-element-row">
									<label for="remarks">Remarks</label> <input type="text" placeholder="Enter remarks"
