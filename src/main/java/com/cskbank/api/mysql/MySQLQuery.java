...
class MySQLQuery {
	...
	static enum Schemas {
		USERS, EMPLOYEES, CUSTOMERS, ACCOUNTS, TRANSACTIONS, BRANCH, CREDENTIALS, AUDIT_LOGS, API_KEYS;
	...
	static enum Column {
		...
		DESCRIPTION, TARGET_ID, VALID_UNTIL, IS_ACTIVE, API_KEY, ORG_NAME, AK_ID;
