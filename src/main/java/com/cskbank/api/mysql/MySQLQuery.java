...
class MySQLQuery {
	...
	static enum Schemas {
		USERS, EMPLOYEES, CUSTOMERS, ACCOUNTS, TRANSACTIONS, BRANCH, CREDENTIALS, AUDIT_LOGS, API_KEYS, USER_TYPES,
		GENDER, STATUS, ACCOUNT_TYPES;
	...
	static enum Column {
		...
		AADHAAR_NUMBER, PAN_NUMBER, ROLE, BRANCH_ID, ACCOUNT_NUMBER, ACCOUNTS, OPENING_DATE, BALANCE, CLOSING_BALANCE,
		TRANSACTION_ID, REMARKS, VIEWER_ACCOUNT_NUMBER, TRANSACTED_ACCOUNT_NUMBER, TRANSACTED_AMOUNT, TRANSACTION_TYPE,
		TIME_STAMP, ALL, PIN, LAST_TRANSACTED_AT, IFSC_CODE, CREATED_AT, MODIFIED_BY, MODIFIED_AT, OPERATION,
		DESCRIPTION, TARGET_ID, VALID_UNTIL, IS_ACTIVE, API_KEY, ORG_NAME, AK_ID, ID, VALUE;
