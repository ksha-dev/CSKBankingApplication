...
public class ConstantsUtil {
	...
	public static enum LogOperation {
		...
		USER_UNBLOCKED, USER_VERIFICATION, USER_STATUS_CHANGE, PASSWORD_RESET_MAIL,

		// Customers
		CREATE_CUSTOMER, CREATE_CUSTOMER_AT_SIGNUP, UPDATE_AADHAAR_NUMBER, UPDATE_PAN_NUMBER, VIEW_CUSTOMER,
		CREATE_CUSTOMER_AND_ACCOUNT, CUSTOMER_CREATION_MAIL,

		// Employees
		CREATE_EMPLOYEE, UPDATE_BRANCH_ID, UPDATE_ROLE, VIEW_EMPLOYEE, EMPLOYEE_CREATION_MAIL,

		// Credentials
		CREATE_CREDENTIALS, UPDATE_PASSWORD, UPDATE_PIN, RESET_PASSWORD,
