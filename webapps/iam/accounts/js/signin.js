...
(function($) {
	...
	$.fn.zaSignIn.defaults = {
		...
		url : function() {
			return ZAConstants.getAbsoluteURL(ZAConstants.contextpath+"/signin.ac"); // No I18N
		},
		params : function() {
...
function openIdSignIn(idp, provider, isClient) {
	...
	var action = isClient ? "/extoauth/clientrequest?" + qs : "/fsrequest?" + qs; // No I18n
	$f.attr({
		action : ZAConstants.getAbsoluteURL(ZAConstants.contextpath+action), 
		method : "post", // No I18N
