...
/////////////////////to initialize placeholder for country phone numbers use phonePattern.initialize(selectTag,phoneNo)/////////////////
	...
	return function(){
		...
		obj.setMobileNumFormat = function(str,countryCode){
			if(countryCode){
				str= str.replace(/[ \-\.]/g,'');
				...
				if(countryCode.indexOf("+") != -1){
					return countryCode+" "+phonePattern.setSeperatedNumber(phonePattern.getCountryObj(phonePattern.getCountryCharCodeWithNumCode(countryCode)),str);
				}
				return phoneData[countryCode].code+" "+phonePattern.setSeperatedNumber(phonePattern.getCountryObj(countryCode),str);
			}
			str = str.replace(/[()]/g, '');
			var countryNumCode, mobileNum;
			if(str.split("")[0] === "+"){
				countryNumCode = str.split(" ")[0];
				mobileNum = str.split(" ")[1];
				return countryNumCode+" "+phonePattern.setSeperatedNumber(phonePattern.getCountryObj(phonePattern.getCountryCharCodeWithNumCode(countryNumCode)),mobileNum);
			}
			countryNumCode = "+"+str.split('-')[0],mobileNum=str.split('-')[1];
			return countryNumCode+" "+phonePattern.setSeperatedNumber(phonePattern.getCountryObj(phonePattern.getCountryCharCodeWithNumCode(countryNumCode)),mobileNum);
		}
		return obj;
	}
