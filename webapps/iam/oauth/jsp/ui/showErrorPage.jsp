...
<%
	...
	boolean showVerifyNowOption = false;
	...
	case access_denied: {
		errorTitle = Util.getI18NMsg(request, "IAM.NEW.SIGNIN.RESTRICT.SIGNIN.HEADER");//No I18N
...
<body>
	...
	<div class="container">
		...
		<div class="heading" id="errorTitle"><%=errorTitle%></div>
		<div class="discrption" id="errorDescription"><%=errorDescryption%></div>
		<% if(showVerifyNowOption){%>
		<div class="verify_now" onclick="location.href='/home#profile/useremails'"><%= Util.getI18NMsg(request,"IAM.VERIFY.NOW")%></div>
		<%} %>
