    	...
    	<table width="100%" height="90%" align="center" cellpadding="0" cellspacing="0">
    		...
    		<tr><td valign="top" align="center">
    			<div class="mainbodydiv">					
					...
					<div id="invhints">
	    				<div class="signindiv"><a href="${redirectUrl}"><@i18n key="IAM.AC.PASSWORD.MATCHED.SIGNIN.REDIRECT"/></a></div>
					...
					<div id="msgboard" class="hide">
	    				<div class="successicon">&nbsp;</div>
	    				<div class="emailconfirmtxt"><@i18n key="IAM.EMAILCONFIRM.SUCCESS" arg0="${emailId}"/>&nbsp;<a href="${redirectUrl}"><@i18n key="IAM.AC.PASSWORD.MATCHED.SIGNIN.REDIRECT"/></a></div>
	  				</div>
					<#else>
					<div id="msgboard">
	    				<div class="successicon">&nbsp;</div>
