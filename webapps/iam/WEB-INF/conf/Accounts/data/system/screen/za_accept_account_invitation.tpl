		...
		<section class="containerbox">
			<form name="accountinvitationform" class="form" action="${za.contextpath}/accinvite.ac" method="post">
						<div id="afterclick" class="margin bg-page-after" style="background :#F2F2F2;">
							...
							<br/><a class="ptxt" id="continueto" href="" style="height: 29px;width: 166px;display: inline-block;box-shadow: 0 0 13px #DDDDDD;text-align: justify;padding: 23px;padding-top: 10px;padding-bottom: 0px;background: #D7D7D0;color:rgb(84, 80, 80);"><@i18n key="IAM.CONTINUE" arg0="${app_display_name}"/></a>
						</div>
						<#if isvalidrequest>
