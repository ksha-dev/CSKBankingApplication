		...
		<section class="signincontainer">
			...
			<div>
				...
				<div>
					...
					<#if zidp.google><span class="GIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.GOOGLE" />' onclick="openIdSignIn('g', '${zidp.googleurl}');" style="text-transform: capitalize;"></span></#if>
					<#if zidp.gapps><span class="GAppsIcon" title='<@i18n key="IAM.SIGNIN.IDP.GAPPS" />' onclick="openIdSignIn('ga', '${zidp.gappsurl}');"></span></#if>
					<#if zidp.yahoo><span class="YIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.YAHOO" />' onclick="openIdSignIn('y', '${zidp.yahoourl}');" style="text-transform: capitalize;"></span></#if>
					<#if zidp.facebook><span class="FIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.FACEBOOK" />' onclick="openIdSignIn('f');" style="text-transform: capitalize;"></span></#if>
				</div>
			</div>
			</#if>
		</section>
