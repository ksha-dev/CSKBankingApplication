...
<#if announcement.newslettercheckbox_needed>
	...
	<div style="margin-left: -4px;margin-top: 7px;"><input id="newlettercheck" type="checkbox"><span style="padding-left: 3px;"><@i18n key="IAM.TPL.ZOHO.NEWSLETTER.SUBSCRIBE1" arg0="${corp_link}"/></span></div>
</#if>
