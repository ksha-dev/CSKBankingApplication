...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;max-width: 700px; min-width: 320px;width:100%;"> 
    ...
    <td align="left" style="padding:2% 2% 2% 0;">
            ...
            <tr border="0">
	            <td>
	                <table border="0" cellpadding="0" cellspacing="0" width="100%">
	                    <tr>
		                    <td>
		                        <a href="<@i18n key="IAM.HOME.LINK" />"><img src="cid:23abc@pc27" style="display: block;height: 60px;width: auto;" /></a>
		                    </td>
	                    </tr>
	                    <tr>
		                    <td style="padding:8px 0 0 12px;font-size: 24px;line-height: 48px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
		                        <b><@i18n key="IAM.USER.MAIL.CONFIRMATION.SUBJECT"/></b>
		                    </td>
	                    </tr>
	                    <tr>
		                    <td style="padding:20px 0 0 12px;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
		                    	<@i18n key="IAM.EMAIL.TPL.WELCOME.TEXT" />
		                    </td>
	                    </tr>
	                    <tr>
		                    <td style="padding:20px 0 0 12px;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
		                        <a style="text-decoration:none;color: #ffffff;display: inline-block;border-top:14px solid #339E72;border-right:40px solid #339E72;border-bottom:14px solid #339E72;border-left:40px solid #339E72;font-size: 16px;font-weight: 600;font-family: 'Open Sans','Trebuchet MS',sans-serif;color: #ffffff;background-color:#339E72;" href="https://www.zoho.com/googleappsforwork.html?utm_source=gapps&utm_medium=mail&utm_campaign=GAfWmailer"><@i18n key="IAM.EMAIL.TPL.LEARN.ABOUT.GAPPS" /></a>
		                    </td>
	                    </tr>
	                    <tr>
		                    <td style="padding:20px 0 0 12px;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
        ...
        <table> 
            <tr>
                <td style="padding:10px 0 10px 12px;font-size: 12px;color:#757575;line-height: 22px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
