		...
		<div style="font-size:11px;color:#000;text-decoration:none;">
	    	<ul style="list-style: none; float: right; *padding-top:10px;">
				...
				<#if partner.isPartnerHideHeader>
					<li style="float: left; margin-right: 20px;"><a href="<@i18n key="IAM.BLOGS.LINK" />" title="<@i18n key="IAM.HEADER.BLOGS" />" style="color:#085DDC;text-decoration:none;" onmouseover="this.style.textDecoration='underline';" onmouseout="this.style.textDecoration='none';"><@i18n key="IAM.HEADER.BLOGS" /></a></li>
					<li style="float: left; margin-right: 20px;"><a href="<@i18n key="IAM.FORUMS.LINK" />" title="<@i18n key="IAM.HEADER.FORUMS" />" style="color:#085DDC;text-decoration:none;" onmouseover="this.style.textDecoration='underline';" onmouseout="this.style.textDecoration='none';"><@i18n key="IAM.HEADER.FORUMS" /></a></li>
				</#if>
				<li style="float: left; margin-right: 20px;"><a href="<@i18n key="IAM.FAQ.LINK" />" title="<@i18n key="IAM.TITLE.FAQ.EXPAND" />" style="color:#085DDC;text-decoration:none;" onmouseover="this.style.textDecoration='underline';" onmouseout="this.style.textDecoration='none';"><@i18n key="IAM.HEADER.FAQ" /></a></li>
	    	</ul>
		</div>
    </div>
</div>
