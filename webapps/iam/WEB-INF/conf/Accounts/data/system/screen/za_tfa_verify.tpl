	...
	<div class="tfa-container" align="center">
		<div id="pageheading" class="za-outer-verify">
			...
			<dl class="za-verify-container">
				<dd>
				    <div>
				    	<span id="verify_button" class="bluebutt_ver old_button" onclick="validateUserCode('$(tfa.isMobile)','$(tfa.serviceName)','$(tfa.serviceUrl)')"><@i18n key="IAM.NEW.SIGNIN.VERIFY"/></span>
