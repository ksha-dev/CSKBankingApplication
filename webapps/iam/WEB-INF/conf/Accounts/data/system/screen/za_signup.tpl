...
<body style="visibility: hidden;">
	...
	<header>
		<div class="logo"></div>
		<div class="signinlink"><@i18n key="IAM.REGISTER.EXISTING.ACCOUNT"/><a href="${signup.signinURL}"><@i18n key="IAM.SIGN_IN" /></a> </div>
...
<div class="inner-container">
					...
					<dl class="za-newsletter-container" style="height:50px;display:none">
						<dd>
							<label for="newsletter" class="news-signup" style="display: flow-root;">
                           	 ...
                           	 <span style="width: 450px;"><@i18n key="IAM.TPL.ZOHO.NEWSLETTER.SUBSCRIBE1" arg0="${corp_link}"/></span>
                       	 </label>
						</dd>
					</dl>
			...
			<section class="signupotpcontainer" style="display:none">
						...
						<dl class="za-submitbtn-otp">
							<dd>
								<input type="button" tabindex="1" class="signupbtn" style="width:180px" value='<@i18n key="IAM.VERIFY.LABEL" />' onclick="validateOTP()" name="otpfield">
								<div class="loadingImg"></div>
							</dd>
						</dl>
			</section>
			...
			<div class="openidcontainer">
				...
				<div class="openidparent">
					<span class="openidlink GIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.GOOGLE" />' onclick="FederatedSignIn.GO('g');" style="text-transform: capitalize;"></span>
				<#if signup.yahoo>
					<span class="openidlink YIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.YAHOO" />' onclick="FederatedSignIn.GO('y');" style="text-transform: capitalize;"></span>
				</#if>
				<#if signup.facebook>
					<span class="openidlink FIcon" title='<@i18n key="IAM.FEDERATED.SIGNIN.FACEBOOK" />' onclick="FederatedSignIn.GO('f');" style="text-transform: capitalize;"></span>
				</#if>
				<#if signup.linkedin>
		...
		<tr><td align="center">
			<div class="signupblockdiv">
				<div class="signupblockheaderdiv">
					<div class="signupblockheader"><span><@i18n key="IAM.NEW.SIGNIN.RESTRICT.SIGNIN.HEADER" /></span></div>
