						...
						<tr border="0">
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									...
									<tr>
										<td style="padding: 20px 0 0 12px; font-size: 14px; line-height: 24px; font-family: 'Open Sans', 'Trebuchet MS', sans-serif;"> <@i18n key="IAM.TPL.REGARDS"/><br> </td>
									<tr>
									<tr>
										<td style="padding:0 0 0 12px;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;"> <b><@i18n key="IAM.PRIVACY.CERTIFICATES.TEAM"/></b><br> </td>
									</tr>
									<tr>
