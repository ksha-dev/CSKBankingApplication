...
<div class="maincontent">
    ...
    <div class="field-bg">
    <%if(Boolean.parseBoolean(AccountsConfiguration.getConfiguration("aoc.resetpassword.redirect", "false"))){ %>
    	<div id="resetpassredirect">Please Access the Reset Password from AOC:</div><br>  <!-- No I18N --><%--No I18N--%>
    	<div id="passredirectlink" style="color:blue;"> <a href="<%=IAMEncoder.encodeHTMLAttribute(AccountsConfiguration.getConfiguration("aoc.server.url", null) + "/admin#user/approvals")%>" target="_blank">Click here</a></div>   <!-- No I18N --><%--No I18N--%>
    <%}
    else{%>
