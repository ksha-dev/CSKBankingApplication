...
//			@@@@Add new Mobile App @@@@
	...
	%>
		<form name="addMobileApp" id="addMobileApp" class="zform" method="post" onsubmit="return configureNewMobileApp(this);">
			...
			<div class="labelkey">Is ClientPortal :</div><%--No I18N--%>
			<div class="labelvalue"><input type="checkbox" class="check" name="isClientPortal" onchange="addClientId(this)"></div>
			<div id="client_portal" style="display:none;">
				<div class="labelkey">Client Id:</div><%--No I18N--%>
				<div class="labelvalue"><input type="text" class="input" name="clientId"/></div>
			</div>
