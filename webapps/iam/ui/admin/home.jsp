...
dc = dc.equals("DEP") ? "" : (dc + " - ");
%>
    <head><title><%=dc + Util.getI18NMsg(request,"IAM.ZOHO.ADMIN")%></title>
<%
...
%>
    ...
    <script src="<%=jsurl%>/jsonformatter.js" type="text/javascript"></script> <%-- NO OUTPUTENCODING --%>
	...
	<%}%>
		...
		<%}
		else if (isIAMRestViewer) {%>
		var submenu = 'rest_panel'; // No I18N
		<%} %>
    ...
    <body>
		...
		<div class="wrappermain">
		    ...
		    <%
		    	} 	if(isIAMAdmin || isIAMSupportAdmin || isIAMUser) {
                    %>
								<div class="spantitle" id="bitsetparse_panel">
			    					<div class="menutitle" onclick="loadPage('bitsetparse_panel','/ui/admin/bitsetparser.jsp')">
										<a href="javascript:;">BitSet Parser</a><%--No I18N--%>
			    					</div>
								</div>
				   ...
				   <%
					...
					%>
						...
						<%
							...
							if (isIAMAdmin || isOAuthAdmin || (Util.isDevelopmentSetup() && isIAMServiceAdmin)) {
						%>
						<div class="spantitle" id="clientscopes">
							<div class="menutitle"
								onclick="loadPage('clientscopes','/ui/admin/clientscopes.jsp')">
								<a href="javascript:;">Client Scopes</a><%--No I18N--%>
							</div>
						</div>
						<%
							}
                    ...
                    %>
								<div class="spantitle" id="clusteradmin">
									<div class="menutitle" onclick="loadPageviaPOST('clusteradmin','/ui/admin/cluster/clusteradmin.jsp?op=view')">
