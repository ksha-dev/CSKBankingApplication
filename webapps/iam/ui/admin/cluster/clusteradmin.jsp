...
<div class="maincontent">
    ...
    <div id='listdiv'>
    	...
    	<td><button onclick='loadui("/ui/admin/cluster/clusterview.jsp?op=view&cluster=<%=IAMEncoder.encodeJavaScript(cluster.getClusterName())%>");'>View</button></td><%--No I18N--%>
    ...
    <div id="headerdiv">&nbsp;</div>
		...
		<div class="labelmain">
			...
			<div class="accbtn Hbtn">
				...
				<div onclick="loaduiviaPOST('/ui/admin/cluster/clusteradmin.jsp?op=view', '', 'clusteradmin');">
					<span class="btnlt"></span>
