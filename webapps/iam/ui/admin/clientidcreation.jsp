					...
					<div class="labelmain">
						...
						<div class="labelvalue">
							<select name="clienttype" onchange="showId(this)">					
								...
								<option value=<%=IAMEncoder.encodeHTML(OAuth2Util.OAuthAppGroup.OAUTH_SPACE.getOAuthAppGroupID()+"_24")%>>EXTERNAL_CLIENTOAUTH_INSTALLABLE</option> <%--No I18N--%>
							</select>
						</div>			
						<div id="hiddenDiv1">
					    ...
					    <div id="hiddenDiv4" style="display:none;">
					    	<div class="labelkey">Enter JS_Domain regex : </div> <%--No I18N--%>
					    	<div class="labelvalue">
								<textarea name="jsDomainRegex" style="font-size:10px;" rows="4" cols="50" placeholder="Enter regex pattern"></textarea> <%--No I18N--%>
							</div>
					    </div>
					    <div id="hiddenDiv5" style="display:none;">
					    	<div class="labelkey">Enter RedirectUri regex : </div> <%--No I18N--%>
					    	<div class="labelvalue">
								<textarea name="redirectUriRegex" style="font-size:10px;" rows="4" cols="50" placeholder="Enter regex pattern"></textarea> <%--No I18N--%>
							</div>
					    </div>
					    <div>
						...
						<div id="jsonresponse">
							...
							<div class="labelvalue">
								<textarea id="addclientId" readonly style="font-size:10px;background-color:#BDBDBD" name="response" rows="10" cols="50"></textarea>
							</div>
					    </div>
					</div>
				</form>
