	...
	<form name="clearcacheinvoker" id="iam_clearcache" class="zform" onsubmit="javascript:return c(this);" method="post">
		<div>
		    <div class="clearcache_list">
		    	<div class="checkiplist" style="font-weight: bold;margin-left:0px;"><input type="checkbox" onclick="checkAllIps(this.checked)"/>Select All IPs</div><%--No I18N--%>
		    	<div class="innerips">
		    	<%
		    ...
		    <div class="activerslink" style="width: 98%;margin: 10px auto 3px;color: #888;font-size: 13px;text-decoration: none;"><span>Select Usecases</span> <a target="_blank" style="text-decoration: none;" href="https://learn.zoho.com/portal/zohocorp/manual/internal-docs-1/article/static-cache-management">(About more)</a></div><%--No I18N--%>
		   <% 
		   JVMCacheUseCase [] values = JVMCacheUseCase.values();
        	for (JVMCacheUseCase value : values) {
				%>
    		    <div class="checkusecaselist" style="padding: 5px;margin-left: 30px;font-size: 13px;"><input type="checkbox" value=<%=value%> id="usecaseclearcache" name=<%=value%>><%=value%></div><%--No I18N--%>
    		    <% 
        	}
		   %> 
	...
	<form name="clearagentcache" id="agent_clearcache" class="zform" onsubmit="return clearAgentConfigurationCache(this);" method="post" style="display:none;">
	    <div class="labelmain">
			...
			<div class="labelvalue">
				...
				<option value="clearlaunchercache">Launcher Cache</option> <%--No I18N--%>
