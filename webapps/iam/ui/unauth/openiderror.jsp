		    ...
		    %>
		     <td>
                               ...
                               <div id="cm_contectdiv" class="label">
                                              		 <div class="inlineLabel"></div>
                                                      <div id="smor_div">
                                                            <span class="redBtn" style="margin-left:170px;" onclick="javascript:window.location.href='<%=IAMEncoder.encodeJavaScript(loginURL)%>';"><%=Util.getI18NMsg(request, "IAM.AC.PASSWORD.MATCHED.SIGNIN.REDIRECT") %></span>
                                                         </div>
                                              </div>	
