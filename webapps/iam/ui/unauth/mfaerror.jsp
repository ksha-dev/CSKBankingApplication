	...
	%> 
					...
					<div style="text-align: center; line-height: 24px;" class="lockcontent">
						...
						<td class="descRtd ele_position" align="center">
							<span class="bluebutt_ver" style="margin-left: -13px;" onclick="mfaredirect('<%=IAMEncoder.encodeJavaScript(redirectUrl)%>');"><%=Util.getI18NMsg(request, "IAM.TRY.AGAIN")%></span>
						</td>
				 	</tr>
				...
				<div id="pageheading" style="width: 100%; text-align: center;">
					...
					<span class="redBtn" style="margin-right:0;padding: 5px 18px" onclick="mfaredirect('<%=IAMEncoder.encodeJavaScript(redirectUrl)%>');"><%=Util.getI18NMsg(request, "IAM.TRY.AGAIN")%></span>
			</div> <%--No I18N--%>
