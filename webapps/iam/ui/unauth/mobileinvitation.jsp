							...
							<dd>
								<div class="inlineLabel"></div>
								 <div class="inputText" style="text-align: left;border:none;margin-left:25%">
										<span id="verify_button" style="padding: 6px 30px;" tabindex="3" class="redBtn" onclick="verifyCode()" onkeypress="if(event.keyCode == 13||event.keyCode == 32){validateUserCode()}"><%=Util.getI18NMsg(request, "IAM.NEW.SIGNIN.VERIFY")%></span>
	        	...
	        	<tr>
	        		<td align="center">
	        			...
	        			<div class="inputText" style="text-align: center;border:none;margin-top:3%">
	        				<span class="cancel-btn" style="padding: 6px 30px;" onclick="window.parent.location.href='<%=IAMEncoder.encodeJavaScript(rejectUrl)%>'"><%=Util.getI18NMsg(request, "IAM.CONTINUE")%></span>
						</div>
					</td>
	        	</tr>
	        </table>
