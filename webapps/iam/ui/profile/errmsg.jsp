...
%>
    ...
    var err_invalid_pass = '<%=Util.getI18NMsg(request,"IAM.ERROR.CODE.U110")%>'; <%--No I18N--%>
    ...
    var err_group_invalid_name = '<%=Util.getI18NMsg(request,"IAM.GROUP.CREATE.ERROR.INVALID.GROUP")%>'; <%--No I18N--%>
    ...
    var grp_name_exists = '<%=Util.getI18NMsg(request,"IAM.ERROR.CODE.G103")%>'; <%--No I18N--%>
	...
	var yu_err_valid_name = '<%=Util.getI18NMsg(request, "IAM.ALLOWEDIP.NAME.NOTVALID")%>';<%--No I18N --%>
    ...
    var authtoken_regenerate_success = '<%=Util.getI18NMsg(request, "IAM.ERROR.UPDATE.SUCCESS.MESSAGE")%>'; <%-- No I18N --%>
    ...
    var err_invalid_password='<%=Util.getI18NMsg(request, "IAM.ERROR.CODE.U110")%>'; <%--No I18N--%>
    ...
    var err_label_exist='<%=Util.getI18NMsg(request, "IAM.ERROR.CODE.TFA101")%>'; <%--No I18N--%>
    ...
    var err_tfa_limit_exceeded='<%=Util.getI18NMsg(request, "IAM.ERROR.CODE.TFA103")%>'; <%--No I18N--%>
    ...
    var err_enter_password='<%=Util.getI18NMsg(request, "IAM.NEW.SIGNIN.PASSWORD")%>';<%--No I18N--%>
	...
	var err_invalid_input = '<%=Util.getI18NMsg(request, "IAM.ERROR.INVALID.INPUT")%>'; <%-- No I18N --%>
	...
	var err_samlsetup_url_pattern = '<%=Util.getI18NMsg(request, "IAM.SAML.SETUP.URL.PATTERN")%>'; <%-- No I18N --%>
