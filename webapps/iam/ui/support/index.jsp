...
dc = dc.equals("DEP") ? "" : (dc + " - ");
%>
<title><%=dc + Util.getI18NMsg(request,"IAM.ZOHO.SUPPORTADMIN")%></title>
							...
							<%if(isIAMAdmin || isIAMSupportAdmin) { %>
								...
								<div class="spantitle" id="appaccountowner_panel">
			    					<div class="menutitle" onclick="loadPage('appaccountowner_panel','/ui/support/appaccountowner.jsp'); initSelect2()">
										<a href="javascript:;">Change AppAccount / ServiceOrg Owner</a><%--No I18N--%>
			    					</div>
								</div>
								...
								<div class="spantitle" id="defaultzsoid_panel">
			    					<div class="menutitle" onclick="loadPage('defaultzsoid_panel','/ui/support/defaultzsoid.jsp')">
										<a href="javascript:;">Change Default ZID</a><%--No I18N--%>
			    					</div>
								</div>
								
                               <div class="spantitle" id="close_appservice_panel">
								<div class="menutitle" onclick="loadPage('close_appservice_panel','/ui/support/closeappservice.jsp')">
										<a href="javascript:;">Close AppAccount / ServiceOrg</a><%--No I18N--%>
                                    </div>
								</div>
