...
var otp_length = <%=MailUtil.Generator.VerificationCode.getLength()%>;
var resend_timer;
...
<%--         	<input class="verify_btn" type="button"  value="<%=Util.getI18NMsg(request, "IAM.HOSTED.EMAIL.PREANNOUNCEMENT.TITLE")%>"> --%>
		    ...
		    <button class="btn" id="ver_id" onclick="VerifyCode(document.getElementById('verify_code').value)"><%=Util.getI18NMsg(request,"IAM.NEW.SIGNIN.VERIFY")%></button>    
