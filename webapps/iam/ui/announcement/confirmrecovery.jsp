...
<div class="blur"></div>
		...
		<div class=" hide popup" id="verify_pop">
			...
			<div id="2nd_step">
				    ...
				    <button class="primary_btn" onclick="verifyCode();"><%=Util.getI18NMsg(request,"IAM.NEW.SIGNIN.VERIFY")%></button><%--No I18N--%>
        ...
        <div class="container">
	        <img class="zoho_logo" src="<%=imgurl%>/newZoho_logo.svg"> <%-- NO OUTPUTENCODING --%>
				   ...
				   if(userEmailList != null) { %>
				 	...
				 	for(UserEmail ue : userEmailList) 
				 	{
					   ...
					   <%}%>
									<div class="single_cell">
										...
										<span class="red_field_value" id="ver<%=i%>" onclick="sendVerifyCode_show('<%=IAMEncoder.encodeHTMLAttribute(ue.getEmailId())%>',false,<%=i %>)" ><%=Util.getI18NMsg(request,"IAM.NEW.SIGNIN.VERIFY")%></span><%--No I18N--%>
					...
					%> 
									<div class="single_cell">
										...
										<span class="red_field_value" id="ver<%=i%>" onclick="sendVerifyCode_show('<%=IAMEncoder.encodeHTMLAttribute(um.getMobile())%>',true,<%=i %>)" ><%=Util.getI18NMsg(request,"IAM.NEW.SIGNIN.VERIFY")%></span><%--No I18N--%><%-- NO OUTPUTENCODING --%>
										<span class="blue_field_value hide" id="done<%=i%>"><%=Util.getI18NMsg(request,"IAM.VERIFIED")%></span><%--No I18N--%>
									</div>
					<%
						i++;
