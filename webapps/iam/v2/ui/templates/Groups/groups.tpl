...
<script type="text/javascript">
 ...
 var i18nGroupkeys = {
				...
				"IAM.GROUP.UNSUBCRIBE" : '<@i18n key="IAM.GROUP.UNSUBCRIBE" />',
				"IAM.GROUP.ERROR.GROUPNAME.VALID" : '<@i18n key="IAM.GROUP.ERROR.GROUPNAME.VALID" />',
				"IAM.GROUP.MEMBERS" : '<@i18n key="IAM.GROUP.MEMBERS" />',
				"IAM.GROUP.MEMBER" : '<@i18n key="IAM.GROUP.MEMBER" />',
				"IAM.GROUP.DESCRIPTION.SYMBOL.ERROR" : '<@i18n key="IAM.GROUP.DESCRIPTION.SYMBOL.ERROR" />',
				"IAM.GROUP.EMAIL.MAX.LENGTH" : '<@i18n key="IAM.GROUP.EMAIL.MAX.LENGTH" />'
		};
 </script>
