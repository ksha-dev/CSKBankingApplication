    					...
    					<div class="box big_box" id="history_box">
							...
							<div id="history_screen" class="box_content_div">
								...
								<div class="no_data no_data_SQ"></div>
									<div class="no_data_text hide" id="empty_history_screen"><@i18n key="IAM.LOGINHISTORY.SHOW" /> </div>
									<div class="no_data_text hide" id="history_unavaiable"><@i18n key="IAM.LOGIN_HISTORY.EMPTY" /> </div>
