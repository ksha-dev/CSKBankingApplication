				...
				<div class="signin_box" id="signin_flow">
					...
					<div id="signin_div">
						...
						<div id='backup_container'>
							...
							<button class="btn blue" onclick="verifyBackupCode()"><@i18n key="IAM.NEW.SIGNIN.VERIFY"/></button>
					...
					<div class="textbox_div" id="npassword_container">
							<input id="new_password" onkeyup="setPassword(event)" placeholder='<@i18n key="IAM.NEW.SIGNIN.PASSWORD.EXPIRED.NEW.PASSWORD"/>' name="newPassword" type="password" class="textbox" required="" oninput="validateCP();" onkeydown="clearCommonError('npassword')" autocapitalize="off" <#if (SCL.isPasswordAutoCompleteOff() == 'true')>autocomplete="off"<#else>autocomplete="new-password"</#if> autocorrect="off" />
					...
					<div class="textbox_div" id="rpassword_container">
							<input id="new_repeat_password" onkeyup="setPassword(event)" placeholder='<@i18n key="IAM.CONFIRM.PASS"/>' name="cpwd" type="password" class="textbox" required="" oninput="validateCP();" onkeydown="clearCommonError('rpassword')" autocapitalize="off" <#if (SCL.isPasswordAutoCompleteOff() == 'true')>autocomplete="off"<#else>autocomplete="new-password"</#if> autocorrect="off" />
