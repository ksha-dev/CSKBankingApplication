...
DataObject dataObject = UserPersonalizationAPI.getPersonalizedView(viewName, AuthenticationUtil.getAccountID());
...
UserPersonalizationAPI.updatePersonalizedView((WritableDataObject)dataObject, AuthenticationUtil.getAccountID());
%>
