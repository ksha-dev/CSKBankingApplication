...
if(request.getParameter("View_Name") != null){
	TablePersonalizationUtil.updateColumnsListForView(request.getParameter("View_Name"), AuthenticationUtil.getAccountID(), request.getParameterValues("SHOW_LIST"), request.getParameterValues("HIDE_LIST"));
	%>
<script>
		windowClose();
	</script>
<%
	...
	TablePersonalizationUtil.setColumnsListForView(request.getParameter("viewName"), AuthenticationUtil.getAccountID(), showList, hideList, request);
%>
</head>
