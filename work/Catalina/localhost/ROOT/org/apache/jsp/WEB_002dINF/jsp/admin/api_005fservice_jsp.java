 ...
 * Generated at: 2024-06-24 11:25:25 UTC
...
public final class api_005fservice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/admin/../include/layout_footer.jsp", Long.valueOf(1719227996420L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("com.cskbank.modules.APIKey");
...
int currentPage = (int) request.getAttribute("currentPage");
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("<title>API Keys</title>\n");
...
UserRecord user = (UserRecord) session.getAttribute("user");
      ...
      out.write("<form action=\"create_api_key\" method=post>\n");
      out.write("		<div\n");
      out.write("			style=\"display: flex; justify-content: space-between; align-items: center; margin-right: 50px;\">\n");
      out.write("			<h3 class=\"content-title\">List of API Keys</h3>\n");
      out.write("			<div style=\"margin: auto\"></div>\n");
      out.write("			<input type=\"text\" name=\"orgName\" placeholder=\"Organisation Name\"\n");
      out.write("				required style=\"min-width: 200px; margin-right: 20px;\"> <input\n");
      out.write("				type=\"submit\" value=\"Create Key\">\n");
      out.write("		</div>\n");
      out.write("	</form>\n");
      out.write("	");
	...
	if (apiKeys.isEmpty()) {
      ...
      out.write("<div class=\"container\">No API Keys have been generated</div>\n");
      out.write("	");
      ...
      out.write("			<thead>\n");
      out.write("				<tr>\n");
      out.write("					<td>API Key ID</td>\n");
      out.write("					<td>Organisation Name</td>\n");
      out.write("					<td>Created At</td>\n");
      out.write("					<td>Expires At</td>\n");
      out.write("					<td>API Key</td>\n");
      ...
      out.write("<tr>\n");
      out.write("					<td>");
      out.print(apikey.getAkId());
      out.write("</td>\n");
      out.write("					<td>");
      out.print(apikey.getOrgName());
      out.write("</td>\n");
      out.write("					<td>");
      out.print(ConvertorUtil.formatToDate(apikey.getCreatedAt()));
      out.write("</td>\n");
      out.write("					<td>");
      out.print(ConvertorUtil.formatToDate(apikey.getValidUntil()));
      out.write("</td>\n");
      out.write("					<td id=\"hiddenKey\">");
      out.print(apikey.getAPIKey());
      out.write("</td>\n");
      out.write("					<td style=\"color: ");
      out.print(apikey.getIsActive() ? "green" : "red");
      out.write('"');
      out.write('>');
      out.print(apikey.getIsActive() ? "Active" : "Expired");
      out.write("</td>\n");
      out.write("					");
      ...
      out.write("<td>\n");
      out.write("						<form action=\"invalidate_api_key\" method=\"post\">\n");
      out.write("							<input type=\"hidden\" name=\"ak_id\" value=\"");
      out.print(apikey.getAkId());
      out.write("\">\n");
      out.write("							<input type=\"submit\" value=\"Invalidate\"\n");
      out.write("								style=\"padding: auto; background: transparent; color: white;\">\n");
      out.write("						</form>\n");
      out.write("					</td>\n");
      out.write("					");
      ...
      out.print(pageCount == 1 ? "#" : "api_service");
      out.write("\"\n");
