 ...
 * Generated at: 2024-06-25 04:49:42 UTC
...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/head.jsp", Long.valueOf(1719289199931L));
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/layout_header.jsp", Long.valueOf(1719289199931L));
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/layout_footer.jsp", Long.valueOf(1719289199931L));
  }
...
if (error != null) {
	...
	out.print("<script>errorMessage('" + error + "');</script>");
      ...
      out.write("<script src=\"../../static/script/search.js\"></script>\n");
      out.write("</head>\n");
      out.write("\n");
      out.write("\n");
      out.write("<body>\n");
...
UserRecord user = (UserRecord) session.getAttribute("user");
      ...
      out.write("<h3 class=\"content-title\">Search</h3>\n");
      out.write("	<form action=\"search\" id=\"search-form\" class=\"container\"\n");
      out.write("		style=\"width: 50%;\" method=\"post\">\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label>Search By</label><select name=\"searchBy\" id=\"searchBy\"\n");
      out.write("				required>\n");
      out.write("				<option style=\"display: none\" value=null>Select Search By</option>\n");
      out.write("				<option value=\"accountNumber\">Account Number</option>\n");
      out.write("				<option value=\"customerId\">Customer ID</option>\n");
      out.write("				");

				if (user.getType() == UserRecord.Type.ADMIN) {
				
      out.write("<option value=\"employeeId\">Employee ID</option>\n");
      out.write("				<option value=\"branchId\">Branch ID</option>\n");
      out.write("				");
      ...
      out.write("</select>\n");
      out.write("		</div>\n");
      out.write("		<span id=\"e-searchBy\" class=\"error-text\"></span>\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label>Search Value</label> <input id=\"searchValue\" type=\"number\"\n");
      out.write("				name=\"searchValue\" placeholder=\"Enter Search Value\" required>\n");
      out.write("		</div>\n");
      out.write("		<span id=\"e-searchValue\" class=\"error-text\"></span> <input\n");
      out.write("			type=\"submit\" value=\"Search\" class=\"dual-element-row\">\n");
      out.write("	</form>\n");
      out.write("	");
      out.write("</div>\n");
      out.write("</section>");
