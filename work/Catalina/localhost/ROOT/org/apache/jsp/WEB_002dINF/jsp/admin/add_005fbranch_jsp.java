 ...
 * Generated at: 2024-06-21 11:32:59 UTC
...
public final class add_005fbranch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/admin/../include/layout_header.jsp", Long.valueOf(1718968968413L));
    _jspx_dependants.put("/WEB-INF/jsp/admin/../include/head.jsp", Long.valueOf(1718968968413L));
    _jspx_dependants.put("/WEB-INF/jsp/admin/../include/layout_footer.jsp", Long.valueOf(1718968968413L));
  }
...
UserRecord user = (UserRecord) session.getAttribute("user");
      ...
      out.write("	</script>\n");
      out.write("	<h3 class=\"content-title\">Add Branch</h3>\n");
      out.write("	<form action=\"authorization\" class=\"container\" style=\"width: 50%;\"\n");
      out.write("		method=\"post\">\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label for=\"address\">Address</label> <input type=\"text\" minlength=\"5\"\n");
      out.write("				name=\"address\" placeholder=\"Enter Branch Address\" required>\n");
      out.write("		</div>\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label for=\"phone\">Phone</label> <input type=\"number\" name=\"phone\"\n");
      out.write("				minlength=\"10\" placeholder=\"Enter Branch Phone Number\" required>\n");
      out.write("		</div>\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label for=\"email\">Email ID </label> <input type=\"text\" id=\"email\"\n");
      out.write("				name=\"email\" placeholder=\"Enter Email ID\" required>\n");
      out.write("\n");
      out.write("			<!--  pattern=\"^[a-z.]{5,}$\"\n");
      out.write("				title=\"Must contain atleast 5 characters\" -->\n");
      out.write("		</div>\n");
      out.write("		<span id=\"error\" style=\"color: red;\"></span> <input type=\"hidden\"\n");
      out.write("			name=\"operation\" value=\"authorize_add_branch\"> <input\n");
      out.write("			type=\"submit\" value=\"Submit\" class=\"dual-element-row\">\n");
      out.write("		<!-- onclick=\"validateUserName()\" -->\n");
      out.write("	</form>\n");
      out.write("	");
      out.write("</div>\n");
      out.write("</section>");
      ...
      out.write("			const email = document.getElementById('userName').value;\n");
      out.write("			const error = document.getElementById('error');\n");
      out.write("			console.log(email.contains(\"@\"));\n");
      out.write("			if (email.contains(\"@\")) {\n");
      out.write("				error.textContent = \"Please enter only the user name and not any other email characters\";\n");
      out.write("			}\n");
