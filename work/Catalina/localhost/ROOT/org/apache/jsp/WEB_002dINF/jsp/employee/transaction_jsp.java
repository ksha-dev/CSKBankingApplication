 ...
 * Generated at: 2024-06-26 09:21:23 UTC
...
public final class transaction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/layout_footer.jsp", Long.valueOf(1719393550343L));
  }
...
if (error != null) {
	...
	out.print("<script>errorMessage('" + error + "');</script>");
      ...
      out.write("<script src=\"../../static/script/transaction.js\"></script>\n");
      out.write("</head>\n");
      out.write("\n");
      out.write("\n");
      out.write("<body>\n");
...
UserRecord user = (UserRecord) session.getAttribute("user");
      ...
      out.write("<h3 class=\"content-title\">Transfer</h3>\n");
      out.write("	<form action=\"authorization\" class=\"container\" method=\"post\"\n");
      out.write("		id=\"transaction-form\" style=\"width: 50%;\">\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label>Transaction Type</label> <select name=\"type\"\n");
      out.write("				id=\"transactionType\" required>\n");
      out.write("				<option style=\"display: none\" value=\"null\">Select\n");
      out.write("					Transaction Type</option>\n");
      out.write("				<option value=\"");
      out.print(TransactionType.CREDIT);
      out.write("\">DEPOSIT</option>\n");
      out.write("				<option value=\"");
      out.print(TransactionType.DEBIT);
      out.write("\">WITHDRAW</option>\n");
      out.write("			</select>\n");
      out.write("		</div>\n");
      out.write("		<span id=\"e-transactionType\" class=\"error-text\"></span>\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label>Account Number</label> <input id=\"accountNumber\" type=\"number\"\n");
      out.write("				name=\"accountNumber\" placeholder=\"Enter Account Number\" required>\n");
      out.write("		</div>\n");
      out.write("		<span id=\"e-accountNumber\" class=\"error-text\"></span>\n");
      out.write("		<div class=\"dual-element-row\">\n");
      out.write("			<label for=\"amount\">Transaction Amount</label> <input type=\"number\"\n");
      out.write("				id=\"amount\" step=\".01\" name=\"amount\" placeholder=\"Enter Amount\"\n");
      out.write("				inputmode=\"numeric\" required>\n");
      out.write("		</div>\n");
      out.write("		<span id=\"e-amount\" class=\"error-text\"></span> <input type=\"hidden\"\n");
      out.write("			name=\"operation\" value=\"authorize_transaction\"> <input\n");
      out.write("			type=\"submit\" value=\"Proceed\" class=\"dual-element-row\">\n");
      out.write("	</form>\n");
      out.write("	");
      out.write("</div>\n");
      out.write("</section>");
      out.write("<script>\n");
      out.write("		const error = document.getElementById(\"error-message\");\n");
      out.write("		function validateAccountSelection() {\n");
      out.write("			const type = document.getElementById(\"type\");\n");
      out.write("			error.textContent = \"\";\n");
      out.write("			if (type.value === \"null\") {\n");
      out.write("				error.textContent = \"Please Select Transaction Type\";\n");
