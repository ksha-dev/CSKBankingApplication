 ...
 * Generated at: 2024-06-14 11:36:38 UTC
...
public final class accounts_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.cskbank.consoleRunner.utility.LoggingUtil");
...
UserRecord user = (UserRecord) session.getAttribute("user");
      ...
      out.write("<h3 class=\"content-title\">Accounts</h3>\n");
      out.write("	");

	if (accounts.isEmpty()) {
	
      out.write("<div class=\"container\">You do not have any accounts currently</div>\n");
      out.write("	");
      ...
      out.write("</td>\n");
      out.write("					<td>");
      out.print(ConvertorUtil.convertLongToLocalDate(account.getOpeningDate()).format(DateTimeFormatter.ISO_DATE));
      out.write("</td>\n");
      out.write("					<td>");
