 ...
 * Generated at: 2024-06-21 11:45:16 UTC
...
public final class open_005faccount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/head.jsp", Long.valueOf(1718969830812L));
    _jspx_dependants.put("/WEB-INF/jsp/employee/../include/layout_header.jsp", Long.valueOf(1718969830812L));
  }
...
if (error != null) {
	...
	out.print("<script>errorMessage('" + error + "');</script>");
      ...
      out.write("<script src=\"../../static/script/open_account.js\"></script>\n");
      out.write("\n");
      out.write("</head>\n");
      out.write("\n");
      out.write("<body>\n");
...
UserRecord user = (UserRecord) session.getAttribute("user");
	...
	if (user.getType() == UserRecord.Type.ADMIN) {
      ...
      out.write("<script>\n");
      out.write("		document.getElementById('li-accounts').style = \"border-left: 5px solid #fff; background: #0d1117; color: white;\";\n");
      out.write("		document.getElementById('a-accounts').href = '#';\n");
      out.write("	</script>\n");
      out.write("	");

	}
	
      out.write("<h3 class=\"content-title\">Open New Account</h3>\n");
      out.write("	<form action=\"authorization\" id=\"open-account-form\"\n");
      out.write("		style=\"width: auto;\" method=\"post\">\n");
      out.write("		<div class=\"container\" style=\"flex-direction: row;\">\n");
      out.write("			<div style=\"width: 50%; padding-right: 50px;\">\n");
      out.write("				<div class=\"dual-element-row\">\n");
      out.write("					<label>Select Account Type</label> <select id=\"accountType\"\n");
      out.write("						name=\"");
      out.print(Parameters.TYPE.parameterName());
      out.write("\">\n");
      out.write("						<option value=null style=\"display: none;\">Account Type</option>\n");
      out.write("						");
      ...
      out.write("</select>\n");
      out.write("				</div>\n");
      out.write("				<span id=\"e-accountType\" class=\"error-text\"></span>\n");
      out.write("				<div class=\"dual-element-row\" id=\"select-customer\">\n");
      out.write("					<label>Select Customer Type</label> <select\n");
      out.write("						onclick=\"triggerCustomerType()\" name=\"customerType\"\n");
      out.write("						id=\"customerType\">\n");
      out.write("						<option value=null style=\"display: none;\">Customer Type</option>\n");
      out.write("						<option value=\"new\">New Customer</option>\n");
      out.write("						<option value=\"existing\">Existing Customer</option>\n");
      out.write("					</select>\n");
      out.write("				</div>\n");
      out.write("				<span id=\"e-customerType\" class=\"error-text\"></span>\n");
      out.write("			</div>\n");
      out.write("			<div style=\"width: 50%;\">\n");
      out.write("				<div class=\"dual-element-row\">\n");
      out.write("					<label for=\"amount\">Deposit Amount</label> <input type=\"number\"\n");
      out.write("						id=\"amount\" name=\"");
      out.print(Parameters.AMOUNT.parameterName());
      out.write("\"\n");
      out.write("						placeholder=\"Enter Deposit Amount\">\n");
      out.write("				</div>\n");
      out.write("				<span id=\"e-amount\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("		</div>\n");
      out.write("		<div id=\"new-customer-fields\" class=\"container\"\n");
      out.write("			style=\"display: none; flex-direction: column;\">\n");
      out.write("			<h3 class=\"profile-element\">Customer Details</h3>\n");
      out.write("			<div class=\"divider\"></div>\n");
      out.write("			<div\n");
      out.write("				style=\"display: flex; flex-direction: row; width: 100%; justify-content: space-between;\">\n");
      out.write("				<div style=\"width: 50%; padding-right: 50px;\">\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"firstName\">First Name</label> <input type=\"text\"\n");
      out.write("							id=\"firstName\" name=\"");
      out.print(Parameters.FIRSTNAME.parameterName());
      out.write("\"\n");
      out.write("							placeholder=\"Enter First Name\" pattern=\"^[a-zA-Z]{3,}\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-firstName\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"lastName\">Last Name</label> <input type=\"text\"\n");
      out.write("							id=\"lastName\" name=\"");
      out.print(Parameters.LASTNAME.parameterName());
      out.write("\"\n");
      out.write("							placeholder=\"Enter Last Name\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-lastName\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label>Date of Birth</label> <input type=\"date\" id=\"dateOfBirth\"\n");
      out.write("							name=\"");
      out.print(Parameters.DATEOFBIRTH.parameterName());
      out.write("\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-dateOfBirth\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"gender\">Gender</label> <select\n");
      out.write("							name=\"");
      out.print(Parameters.GENDER.parameterName());
      out.write("\" id=\"gender\">\n");
      ...
      out.write("</select>\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-gender\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"address\">Address</label> <input type=\"text\"\n");
      out.write("							placeHolder=\"Enter Address\" id=\"address\"\n");
      out.write("							name=\"");
      out.print(Parameters.ADDRESS.parameterName());
      out.write("\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-address\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("				</div>\n");
      out.write("\n");
      out.write("				<div style=\"width: 50%;\">\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"phone\">Mobile</label> <input type=\"number\" id=\"phone\"\n");
      out.write("							name=\"");
      out.print(Parameters.PHONE.parameterName());
      out.write("\"\n");
      out.write("							placeholder=\"Enter Phone Number\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-phone\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      ...
      out.write("					</div>\n");
      out.write("					<span id=\"e-email\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"aadhaar\">Aadhaar Number</label> <input type=\"text\"\n");
      out.write("							id=\"aadhaar\" name=\"");
      out.print(Parameters.AADHAAR.parameterName());
      out.write("\"\n");
      out.write("							placeholder=\"Enter Aadhaar Number\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-aadhaar\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"pan\">PAN</label> <input type=\"text\"\n");
      out.write("							name=\"");
      out.print(Parameters.PAN.parameterName());
      out.write("\" id=\"pan\"\n");
      out.write("							placeholder=\"Enter PAN Number\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-pan\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("				</div>\n");
      out.write("			</div>\n");
      out.write("		</div>\n");
      out.write("\n");
      out.write("		<div id=\"existing-customer-fields\" class=\"container\"\n");
      out.write("			style=\"display: none; flex-direction: column;\">\n");
      out.write("			<h3 class=\"profile-element\">Customer Details</h3>\n");
      out.write("			<div class=\"divider\"></div>\n");
      out.write("			<div\n");
      ...
      out.write("				<div style=\"width: 50%; padding-right: 50px;\">\n");
      out.write("					<div class=\"dual-element-row\">\n");
      out.write("						<label for=\"userId\">Customer ID</label> <input type=\"number\"\n");
      out.write("							id=\"userId\" name=\"");
      out.print(Parameters.USERID.parameterName());
      out.write("\"\n");
      out.write("							placeholder=\"Enter Customer ID\">\n");
      out.write("					</div>\n");
      out.write("					<span id=\"e-userId\" class=\"error-text\"></span>\n");
      out.write("\n");
      out.write("				</div>\n");
      out.write("\n");
      ...
      out.write("		</div>\n");
      out.write("\n");
      out.write("		<input type=\"hidden\" value=\"authorize_open_account\" name=\"operation\">\n");
      out.write("		<button id=\"submit-button\"\n");
      out.write("			style=\"display: block; margin-left: auto; margin-right: 50px;\"\n");
      out.write("			type=\"submit\">Finish</button>\n");
      out.write("	</form>\n");
      out.write("\n");
      out.write("	</div>\n");
      out.write("	</section>\n");
